        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl">
            ...
            <div className="animate-on-scroll">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight mb-6 bg-gradient-to-r from-[#D4AF37] to-[#FF9F4A] bg-clip-text text-transparent">
              ...
              <div className="space-y-4 mb-8">
                <h3 className="text-[var(--text)] font-semibold text-lg">What's Included:</h3>
              ...
              <div className="bg-gradient-to-r from-orange-500/10 to-pink-500/10 border border-orange-500/30 rounded-2xl p-6 mb-8">
                <p className="text-[var(--text)] font-semibold mb-2">Find $3,500+ in revenue leaks or it's free</p>
                <p className="text-muted text-sm">If we don't identify actionable opportunities worth at least $3,500, the audit is completely free.</p>
              </div>

              {/* Timeline */}
              <div className="bg-[var(--surface)] backdrop-blur-sm border border-surface rounded-2xl p-6">
                <h3 className="text-[var(--text)] font-semibold mb-4">Timeline</h3>
            ...
            {/* Right: Form */}
            <div className="animate-on-scroll">
              <div className="bg-[var(--surface)] backdrop-blur-sm border border-surface rounded-3xl p-8 md:p-10 sticky top-24">
                <div className="mb-8">
                ...
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-[var(--text)] font-semibold text-lg mb-2">Thank you!</h3>
                    <p className="text-muted mb-6">We'll be in touch within 48 hours to schedule your discovery call.</p>
                    <Link href="/" className="inline-flex items-center gap-2 text-primary hover:text-orange-400 transition">
                      ← Return home
                    </Link>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Website */}
                    <div>
                      <label className="block text-[var(--text)] font-semibold mb-2">Brand Website</label>
                      <input
                        type="url"
                        name="website"
